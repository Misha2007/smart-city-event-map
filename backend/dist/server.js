...
import { Client, Environment, OrdersController, ApiError, OrderApplicationContextUserAction, CheckoutPaymentIntent, } from "@paypal/paypal-server-sdk";
...
app.post("/api/paypal/order/create", async (req, res) => {
    try {
        ...
        const ordersController = new OrdersController(client);
        console.log("ordersController prototype methods:", Object.getOwnPropertyNames(Object.getPrototypeOf(ordersController)));
